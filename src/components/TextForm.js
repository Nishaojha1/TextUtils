...
export default function TextForm(props) {
    ...
    return (
        ...
        <button className="btn btn-primary mx-2 my-2" onClick={handleUpClick}>Conver to upper case</button>
        <button className="btn btn-primary mx-2 my-2" onClick={handleLowClick}>Conver to lower case</button>
